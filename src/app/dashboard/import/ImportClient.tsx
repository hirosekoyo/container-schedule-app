...
export function ImportClient({ latestUpdateTime }: ImportClientProps) {
  ...
  // ▼▼▼ 変更点1: 表示用の最終更新時刻をフォーマット ▼▼▼
  const formattedLatestUpdate = latestUpdateTime
    ? format(toDate(latestUpdateTime, { timeZone: 'Asia/Tokyo' }), 'MM/dd HH:mm')
    : null;
