    ...
    >
      ...
      <div ref={graphAreaRef} className="relative h-full w-full">
        ...
        {graphAreaWidth > 0 && schedules.map((schedule) => {
          ...
          let blockClassName = 'bg-sky-100 text-sky-800'; // デフォルト色
          if (latestImportId) {
          ...
          return (
            ...
            <div 
              ...
              // 1. テンプレートリテラルを使って、共通のクラスと動的なクラスを結合
              className={`absolute flex items-center justify-center rounded-md border p-1 shadow-sm transition-colors ${blockClassName}`} 
